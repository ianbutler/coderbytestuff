...
// largest word within in. So for example: if strArr is 
// ["hello", "world", "before", "all"] your output should be world because
// "before" is 6 letters long, and "hello" and "world" are both 5, but the
// output should be world because it appeared as the last 5 letter word
// in the array. If strArr was ["hello", "world", "after", "all"] the output
